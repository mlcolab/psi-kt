...
class DataReader(object):
    ...
    def __init__(
        ...
        self.inter_df = pd.read_csv(os.path.join(self.data_dir, self.dataset, 'interactions_{}.csv'.format(self.max_step)), sep='\t')
        self.corpus_path = os.path.join(self.data_dir, self.dataset, 'Corpus_{}.pkl'.format(self.max_step))
    ...
    def create_corpus(self):
        ...
        self.logs.write_to_log_file('Reading data from \"{}\", dataset = \"{}\" '.format(self.data_dir, self.dataset))
    ...
    def gen_time_split_data(
        ...
        val_size = math.ceil(n_time_steps * val_ratio)# n_time_steps-train_size-test_size
