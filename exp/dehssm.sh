...
# --model_name VanillaOU \
# --em_train 0 \
# --overfit 0 --num_sample 50 --batch_size 64 --eval_batch_size 512 \
# --test 1 --test_every 1 --validate 1 \
# --lr_decay 30 --lr 5e-2 --vcl 0 \
# --max_step 50 --gpu 0 \
# --multi_node 1 \
# --train_mode ls_split_time \
# --epoch 200 --train_time_ratio 0.2 --test_time_ratio 0.6 --early_stop 0 \

python exp_learner_predict.py --dataset assistment17/multi_skill \
--model_name GraphHSSM \
--em_train 0 \
--overfit 128 --num_sample 50 --batch_size 64 --eval_batch_size 512 \
--test 1 --test_every 1 --validate 0 \
--lr_decay 30 --lr 5e-2 --vcl 0 \
--max_step 50 --gpu 0 \
--multi_node 1 \
--train_mode ls_split_time \
