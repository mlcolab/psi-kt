...
srun --ntasks=1 --cpus-per-task=$SLURM_CPUS_PER_TASK python single_learner_single_skill_predict.py \
--dataset Duolingo \
--model_name PPE --max_step 200 --gpu 0 \
--epoch 100 --overfit 0 \
--batch_size 256 --validate --train_time_ratio 0.5 --test_time_ratio 0.4 \
