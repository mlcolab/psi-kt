...
--model_name SwitchingNLDS --load 0 --max_step 200 --gpu 0 \
--epoch 100 --overfit 512 \
--validate --train_time_ratio 0.5 --test_time_ratio 0.4 --early_stop 0 \
...
# srun python single_learner_single_skill_predict.py --dataset junyi/single_user_single_skill \
# --model_name SwitchingNLDS --load 0 \
# --max_step 200 --lr 5e-3 --l2 1e-5 --time_log 5 --gpu 0 \
# --epoch 200 --overfit 512 --emb_size 16 --time_lag 50 --emb_size 8 \
# --batch_size 16 --validate --train_time_ratio 0.5 --test_time_ratio 0.4 --early_stop 0 \
# --eval_batch_size 16