...
def test_eva_termination_multiple_metrics():
    ...
    result = kt_runner._eva_termination(None, kt_runner.metrics, kt_runner.logs.val_results)
    # unittest.TestCase.assertFalse(result)
    assert result == False

def test_eva_termination_multiple_metrics_all_decreasing():
...
if __name__ == '__main__':
    ...
    test_eva_termination_multiple_metrics()
    test_eva_termination_multiple_metrics_all_decreasing()