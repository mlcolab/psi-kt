...
if __name__ == '__main__':
    ...
    #     global_args.device = [torch.device("cuda:{}".format(i)) for i in range(torch.cuda.device_count())]
    # else: global_args.device = [torch.device("cpu")]
