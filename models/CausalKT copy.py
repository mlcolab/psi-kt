...
class CausalKT(BaseModel):
    ...
    def parse_model_args(parser, model_name='CausalKT'):
        ...
        parser.add_argument('--dense_var_adj', type=int, default=0, help='for debug use! 0: wo_dense_init; 1: dense_init; 2: constant')                 
        parser.add_argument('--dense_w', type=int, default=0, help='for debug use! 0: zeros_init; 1:ones_init; 2: ones_constant')      
        parser.add_argument('--diagonal', type=int, default=0, help='for debug use! 0: wo_diagonal; 1: w_diagonal')      
