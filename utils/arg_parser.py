...
def parse_args(parser):
    ...
    parser.add_argument(
                '--train_mode', type=str, default='simple_split_time', 
                help= 'simple_split_time' + 'simple_split_learner' 
                + 'ls_split_time' 
                + 'ns_split_time' + 'ns_split_learner'
                + 'ln_split_time', 
            ) #
    parser.add_argument("--validate", default=1, type=int, help="validate results throughout training.")
    ...
    parser.add_argument('--metric', type=str, default='Accuracy, F1, Recall, Precision, AUC', 
